defmodule YachanakuyWeb.UserLiveTest do
  use YachanakuyWeb.ConnCase

  import Phoenix.LiveViewTest
  import Yachanakuy.AccountsFixtures

  @create_attrs %{email: "some email", nombre_completo: "some nombre_completo", rol: "some rol", activo: true}
  @update_attrs %{email: "some updated email", nombre_completo: "some updated nombre_completo", rol: "some updated rol", activo: false}
  @invalid_attrs %{email: nil, nombre_completo: nil, rol: nil, activo: false}
